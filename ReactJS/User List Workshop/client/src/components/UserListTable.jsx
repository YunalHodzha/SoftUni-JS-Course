...
export const UserListTable = () => {
    ...
    const userInfoClickHangler = async (userId) => {
    ...
    const deleteUserClickHandler = (selectedUserId) => {
    ...
    return (
        <>
            ...
            {showInfo && <UserInfoModal onClose={() => setShowInfo(false)} userId={selectedUserId} />}
