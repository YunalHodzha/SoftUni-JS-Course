...
const host = 'http://127.0.0.1:5501/Applications/clientSideRendering/exe/04.Fill-Dropdown/index.html'; // Application host (NOT service host - that can be anything)
